...
public class App {
    ...
    public static void main(String[] args) {
        ...
        playlistMusicas
                .adicionar(new Musica_CD("musicaKatyPerry", "albumKatyPerry", "KatyPerry", "KatyPerry", 2008));
        ...
        playlistMusicas.adicionar(new Musica_MP3("musicaTaylorSwift", "albumTaylorSwift", "TaylorSwift", "TaylorSwift",
                2006, 85));
        playlistMusicas.adicionar(new Musica_MP3("musicaArcticMonkeys", "albumArcticMonkeys", "ArcticMonkeys",
                "ArcticMonkeys", 2006, 115));
        playlistMusicas
                .adicionar(new Musica_MP3("musicaTheWeekend", "albumTheWeekend", "TheWeekend", "TheWeekend", 2015,
                        100));
