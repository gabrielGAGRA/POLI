package LabOO.Provas.P2.Copilot.src.app;
        ...
        while (running) {
            ...
            case 6:
                ...
                bib.listarAtrasados(dataReferencia).forEach(e -> {
                    System.out.println("Usuário: " + e.getUsuario().getNome() + ", Dias em atraso: "
                            + e.calcularDiasAtraso(dataReferencia) + ", Embargo até: "
                            + e.getUsuario().getEmbargoAte());
                });
                break;
