...
public class Usuario {
    ...
    /*
     * Os usuários podem ficar impedidos de fazer empréstimos dentro de um certo
     * período, como punição por descumprimento de regras; o sistema deve armazenar
     * tal informação na ficha de cada usuário.
     */
    ...
    // O sistema deve possuir ao menos as funcionalidades de cadastramento de
    // usuário
    Usuario(Boolean banido, String dataBanido, int registroIdentificacaoPessoal, String dataNascimento,
            String endereco) {
        this.banido = banido;
    ...
    /*
     * busca de usuários pelo início do nome (para usuários que esqueçam seus
     * identificadores)
     */
    public List<Usuario> buscaUsuario_Nome(String nome) {
        ...
        for (Usuario usuario_x : listaUsuarios) {
            // CRÉDITOS (nao copiei, mas pesquisei):
            // https://www.google.com/search?client=firefox-b-e&channel=entpr&q=java+search+by+string+start
